...
public class Colours {
	...
	public static Color[] colourList=new Color[]{dark, darkRed, darkBlue, darkGrey, brown, green, red, grey, blue, orange, lightGrey, lightGreen, pink, lightBlue, yellow, light};
